...
# Cấu hình AI client với AsyncOpenAI để không chặn event loop
client = AsyncOpenAI(
...
async def on_message(message):
    ...
    # Sử dụng typing indicator để người dùng biết bot đang xử lý
    async with message.channel.typing():
        try:
            ...
            # Giới hạn độ dài tin nhắn Discord và thêm dấu ba chấm nếu bị cắt
