...
# Always use "NVIDIA_API_KEY" as the environment variable name
client = AsyncOpenAI(
...
async def on_message(message):
    ...
    # Visual UX: Immediate visual typing indicator in Discord channel
    async with message.channel.typing():
        try:
            # Use AsyncOpenAI client to avoid blocking the single-threaded event loop
            ...
            # Discord message limit is 2000. Truncating to 1900 with '...' if exceeded.
